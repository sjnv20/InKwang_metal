          ...
          <div className="box">
            <Box sx={{ width: 700 }}>
              <AppBar position="static" style={{backgroundColor:'#fff',  boxShadow:"none"}}>
                ...
                >
                  <Tab id="p_tab1" sx={{backgroundColor:"#15137C", fontSize:"18px", fontFamily:"NanumSquareBold", width:'25%', borderStartEndRadius:'80px 80px;', opacity:'1', zIndex:"20"}} label="인산염 피막" {...a11yProps(0)} />
                ...
                <TabPanel value={value} index={0} dir={theme.direction}>
                  <div className='pr_fill'>
                    ...
                    <pre>
                      - 목적 :  금속 제품을 화학약품 탱크에 담그어 피막을 형성시켜, 금속 제품의 부식을 방지하고 <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;녹을 방지하는 표면 처리 과정 <br/>
